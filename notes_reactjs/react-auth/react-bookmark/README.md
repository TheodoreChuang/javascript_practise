...
# Beast Mode+
* Implement a filter for a users bookmarks based on text input

# Beast Mode++# 
* Create a system for URL shortening.
* Example: https://repl.it/talk/learn/Build-your-very-own-URL-shortener/9611?ref=newsletter

# Beast Mode+++
* Make a way for a user to create different directories they can store their bookmarks in.
